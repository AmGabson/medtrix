...
<input class="nk-kycfm-control" type="radio" name="id-proof" id="passport" data-title="Passport" checked=""><label class="nk-kycfm-label" for="passport"><span class="nk-kycfm-label-icon"><span class="label-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 71.9904 75.9285">
...
</svg></span></span><span class="nk-kycfm-label-text">National ID</span></label></li>
<li class="nk-kycfm-control-item"><input class="nk-kycfm-control" type="radio" name="id-proof" id="driver-licence" data-title="Driving License"><label class="nk-kycfm-label" for="driver-licence"><span class="nk-kycfm-label-icon"><span class="label-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76 76">
...
<div class="upload-zone dropzone dz-clickable frontDropZone">
<div class="dz-message">
<span class="dz-message-text">Drag and drop file</span>
<span class="dz-message-or">or</span>
<label for="idFront" class="btn btn-primary">SELECT</label>
<input type='file' name='idFront' class='display-none' id='idFront' accept="image/*" />
</div>
<div class="dz-preview dz-processing dz-image-preview dz-error dz-complete display-none" id="frontCon"> 
<div class="dz-image">
<img alt="" src="" id="idFrontResult">
</span>
</div>
...
<div class="mx-md-4">
<img src="../images/id-front.svg" alt="ID Front"></div>
</div>
</div>
</div>
<div class="nk-kycfm-upload">
...
<div class="col-sm-4 d-none d-sm-block">
<div class="mx-md-4">
<img src="../images/id-back.svg" alt="ID Back"></div>
</div>
</div>
</div>
</div>
...
<label class="custom-control-label" for="tc-agree">I Have Read The <a href="#">Terms Of Condition</a></label></div>
</div>

<div class="nk-kycfm-action pt-2"><button type="submit" class="btn btn-lg btn-primary">Process for Verify</button></div>
</div>
</div>
</div>
</div>
