...
<head>
<title>Patient KYC | Medtrix</title>
...
<div class="nk-content nk-content-fluid kyc-con">
...
<p>
<p>Complete your KYC Verification by filling the form below</p>
</p>
</div>
</div>
<div class="nk-block-head-content">
...
<!-- Onclick of continue btn when kYC has been submited -->
   <div class="col-md-12 display-none success">
   <div class="card card-bordered">
   <div class="card-inner">
   <h5 class="mt-10">SUBMTTED</h5>
   <div class="alert alert-primary alert-icon"><em class="icon ni ni-alert-circle"></em> <strong>PENDING</strong>. Your KYC has been submitted and awaiting approval. Check back later</div>

   <button class="btn btn-primary preview">Preview KYC</button>
   </div>
   </div>
   </div>
...
<?php 
 if(empty($row["residentialCountry"]) || empty($row["city"]) || empty($row["dob"]) || empty($row["phone"]) || empty($row["phone"])){
  ...
  echo '
   ...
   <div class="card card-bordered">
   <div class="card-inner">
  <h5 class="mt-10">Please Update Profile</h5>
  <div class="nk-block-des text-soft mb-3"><p>To continue, you need to update your Profile</p></div>
  <a href="profile.php" class="btn btn-danger">Update Profile &nbsp; <em class="icon ni ni-chevron-right"></em></a>
  </div>
  </div>
  </div>';
  ...
  echo '
   ...
   <div class="card card-bordered">
   <div class="card-inner">
   <h5 class="mt-10">Profile Photo</h5>
   <div class="nk-block-des text-soft mb-3"><p>Please update your Profile Photo to continue</p></div>
   <a href="profile.php" class="btn btn-danger">Update Profile &nbsp; <em class="icon ni ni-chevron-right"></em></a>
   </div>
   </div>
   </div>'; 
 ...
 //if user filled KYC and is still Pending
 elseif($row["kycVerify"] == "pending"){
  echo '
   <div class="col-md-12">
   <div class="card card-bordered">
   <div class="card-inner">
 ...
 //if KYC APproved
 elseif($row["kycVerify"] == "approved"){
  echo '
   <div class="col-md-12">
   <div class="card card-bordered">
   <div class="card-inner">
   <h5 class="mt-10">VALIDATED</h5>
   
   <div class="alert alert-success alert-icon"><em class="icon ni ni-check-circle"></em> <strong>APPROVED</strong>. Congratulations, your KYC has been successfully approved</div>
    <button class="btn btn-success preview">Preview KYC</button>
   </div>
   </div>
   </div>'; 
 }
...
<!-- KYC FORM -->
<div class="col-md-12 kyc-body">

<!-- If KYC WAS Declined -->
 <?php  if($row["kycVerify"] == "declined"){ ?>
<div class="alert alert-danger alert-icon mt-n3"><em class="icon ni ni-cross-circle"></em> <strong>DECLINED</strong>. Your KYC was Declined. Please refill form and IDs with appropriate information.</div>
<button class="btn btn-danger preview mb-2 mt-n1">Preview KYC</button>
<?php }?>
...
<div class="nk-kycfm-note"><em class="icon ni ni-info-fill" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Tooltip on right" data-bs-original-title="Tooltip on right"></em>
<p>Please type carefully and fill out the form with your personal details. You can’t edit these details once the form is submitted.</p>
</div>
<div class="row g-4">
<div class="col-md-6">
<div class="form-group">
<div class="form-label-group"><label class="form-label">First Name <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" disabled class="form-control form-control-lg" value="<?php echo $fname;?>">
</div>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<div class="form-label-group"><label class="form-label">Last Name <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" disabled class="form-control form-control-lg" value="<?php echo $lname;?>">
</div>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<div class="form-label-group"><label class="form-label">Email Address <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" class="form-control form-control-lg" disabled value="<?php echo htmlspecialchars($row["email"]);?>">
</div>
</div>
</div>
...
<div class="col-md-6">
<div class="form-group">
<div class="form-label-group"><label class="form-label">Phone Number <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" disabled class="form-control form-control-lg" 
value="<?php if(!empty($row["phone"])){echo htmlspecialchars($row["phone"]);}?>"></div>
</div>
</div>

<div class="col-md-6">
<div class="form-group">
<div class="form-label-group"><label class="form-label">Date of Birth <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" disabled value="<?php if(!empty($row["dob"])){echo htmlspecialchars($row["dob"]);}?>" class="form-control form-control-lg date-picker-alt"></div>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<div class="form-label-group">
<label class="form-label">Username <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" disabled value="<?php echo htmlspecialchars($row["username"]);?>"  class="form-control form-control-lg text-capitalize"></div>
</div>
</div>
</div>
</div>
...
<div class="form-group">
<div class="form-label-group">
<label class="form-label">Address Line <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" disabled value="<?php if(!empty($row["address"])){echo htmlspecialchars($row["address"]);}?>" class="form-control form-control-lg"></div>
</div>
</div>
...
<div class="form-control-group">
<input type="text" disabled value="<?php if(!empty($row["city"])){echo htmlspecialchars($row["city"]);}?>" class="form-control form-control-lg"></div>
</div>
</div>
...
<div class="form-group">
<div class="form-label-group">
<label class="form-label">State <span class="text-danger">*</span></label></div>
<div class="form-control-group">
<input type="text" disabled class="form-control form-control-lg" value="<?php if(!empty($row["state"])){echo htmlspecialchars($row["state"]);}?>">
</div>
</div>
</div>
...
<div class="form-control-group">
<input type="text" disabled value="<?php if(!empty($row["country"])){echo htmlspecialchars($row["country"]);}?>" class="form-control form-control-lg date-picker-alt">
</div>
</div>
</div>
...
<label class="nk-kycfm-label" for="passport"><span class="nk-kycfm-label-icon">
...
<li class="nk-kycfm-control-item">
<input class="nk-kycfm-control" type="radio" name="id-proof" id="national-id" data-title="National ID" value="national id">
<label class="nk-kycfm-label" for="national-id">
<span class="nk-kycfm-label-icon"><span class="label-icon">
...
<span class="nk-kycfm-label-text">National ID</span></label>
</li>


<li class="nk-kycfm-control-item">
<input class="nk-kycfm-control" type="radio" name="id-proof" id="driver-licence" data-title="Driving License" value="driver licence">
<label class="nk-kycfm-label" for="driver-licence"><span class="nk-kycfm-label-icon"><span class="label-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76 76">
...
</svg></span></span><span class="nk-kycfm-label-text">Driving License</span></label></li>
</ul>
...
<div class="nk-kycfm-upload mt-4">
<!-- FRONT -->
<h6 class="title nk-kycfm-upload-title mb-n2">Upload ID Front</h6>
<div class="row align-items-center">
<div class="col-sm-7">
<span class="result"></span>
<div style="min-height: 150px;border: 1px dashed #e5e9f2; border-radius:4px;padding: 20px 20px;">
<div class="dz-message text-center">

<div class="err1 mb-n2"></div>
<button class="btn btn-primary showBtn1 mt-4 display-none" disabled="">
<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span>Uploading...</span>
</button>

<label for="idFront" class="btn btn-primary lab1 mt-4">SELECT FRONT ID</label>
<input type='file' name='idFront' class='display-none' id='idFront' accept="image/*" />
</div>
</div>
</div>
...
<div class="col-sm-5">
<div class="mx-md-4">
<img src="../images/id-front.svg" alt="ID Front" style="max-height: 200px;" id="idFrontResult">
</div>
</div>
</div>
...
<!-- BACK -->
<h6 class="title nk-kycfm-upload-title mb-n2 mt-3">Upload ID Back</h6>
<div class="row align-items-center">
<div class="col-sm-7">
<span class="result"></span>
<div style="min-height: 150px;border: 1px dashed #e5e9f2; border-radius:4px;padding: 20px 20px;">
...
<div class="err2 mb-n2"></div>
<button class="btn btn-primary showBtn2 mt-4 display-none" disabled="">
<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span>Uploading...</span>
</button>

<label for="idBack" class="btn btn-primary lab2 mt-4">SELECT BACK ID</label>
<input type='file' name='idBack' class='display-none' id='idBack' accept="image/*" />
</div>
</div>
</div>
...
<div class="col-sm-5">
<div class="mx-md-4">
<img src="../images/id-back.svg" alt="ID Back" style="max-height: 200px;" id="idBackResult">
</div>
</div>
</div>
...
<div class="card-footer bg-white border-top display-none continue">
<button class="btn btn-danger">Submit and Continue</button>
</div>
...
//auto select passport as id type
$("#passport").trigger("click");
var idType = "passport"; //set ajax page 


//id type
$('input[name="id-proof"]').change(function(){
   idType = $(this).val();
   console.log(idType);
});
...
//ID FRONT
 ...
 $('#idFront').change(function(){
  var form_data = new FormData();
  var files = $('#idFront')[0].files;


   for(var i=0; i<files.length; i++)
   {
    var name = document.getElementById("idFront").files[i].name;
    var ext = name.split('.').pop().toLowerCase();
    if(jQuery.inArray(ext, ['gif','png','jpg','jpeg']) == -1) 
    {

	//Toast error
   $(".err").html('<div class="alert alert-danger alert-icon alert-dismissible"> <strong>Please select a valid image file</strong> <button class="close" data-bs-dismiss="alert"></button></div>')
	
	return false;
    }
    var oFReader = new FileReader();
    oFReader.readAsDataURL(document.getElementById("idFront").files[i]);
    var f = document.getElementById("idFront").files[i];
    var fsize = f.size||f.fileSize;
    if(fsize > 9194304) //9mb
    {
      
	//Toast error
   $(".err").html('<div class="alert alert-danger alert-icon alert-dismissible"> <strong>Image is too large. Allowed size 9MB</strong> <button class="close" data-bs-dismiss="alert"></button></div>')
	
return false;
    }
    else
    {
     form_data.append("idFront[]", document.getElementById('idFront').files[i]);
     form_data.append("idType", idType);
    }
   }
   ...
   $.ajax({
    ...
    processData: false,
    beforeSend:function(){
      $(".lab1").addClass("display-none");
      $(".showBtn1").removeClass("display-none");
		// NLoader show
		NProgress.start();
	},   
    success:function(data){
		...
		//Embed image
		$(".result").html(data);
      $(".lab1").removeClass("display-none");
      $(".showBtn1").addClass("display-none");
...
//ID BACK
 ...
 $('#idBack').change(function(){
  var form_data = new FormData();
  var files = $('#idBack')[0].files;


   for(var i=0; i<files.length; i++)
   {
    var name = document.getElementById("idBack").files[i].name;
    var ext = name.split('.').pop().toLowerCase();
    if(jQuery.inArray(ext, ['gif','png','jpg','jpeg']) == -1) 
    {
   ...
   $(".err").html('<div class="alert alert-danger alert-icon alert-dismissible"> <strong>Please select a valid image file</strong> <button class="close" data-bs-dismiss="alert"></button></div>')
    ...
    var oFReader = new FileReader();
    oFReader.readAsDataURL(document.getElementById("idBack").files[i]);
    var f = document.getElementById("idBack").files[i];
    var fsize = f.size||f.fileSize;
    if(fsize > 9194304) //9mb
    {
...
return false;
    ...
    {
     form_data.append("idBack[]", document.getElementById('idBack').files[i]);
     form_data.append("idType", idType);
    }
   }
   ...
   $.ajax({
    ...
    processData: false,
    beforeSend:function(){
      $(".lab2").addClass("display-none");
      $(".showBtn2").removeClass("display-none");
		// NLoader show
		NProgress.start();
	},   
    success:function(data){
		...
		//Embed image
		$(".result").html(data);
      $(".lab2").removeClass("display-none");
      $(".showBtn2").addClass("display-none");
