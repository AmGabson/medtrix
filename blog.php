...
<title inertia="">Blog | MedTrix</title>
</script>
</head>
...
<h3 class="inherits-color relative z-10 text-balance text-3xl font-semibold leading-tighter tracking-tight md:text-6xl">Medtrix Blog</h3><!----></header>
