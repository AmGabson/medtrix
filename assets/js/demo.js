    ...
    return function e(d) {
        ...
        function o(e, t, o) {
            if ("undefined" != typeof document) {
                "number" == typeof (o = s({
                    path: "/"
                }, r.defaults, o)).expires && (o.expires = new Date(+new Date + 864e5 * o.expires)),
...
function(r, s) {
    ...
    r.Demo = {
        ...
        apps: function(e) {
            for (var t, o = window.location.pathname.split("/").map(function(e, t, o) {
                return e.replace("-", "")
            }), a = 0, n = f; a < n.length; a++) {
                var i = n[a];
                0 <= o.indexOf(i) && (t = i)
            }
            return e ? e + "_" + t : t
        ...
        apply: function() {
            ...
            for (var e = 0, t = i; e < t.length; e++) {
                var o, a, n = t[e];
                "aside" !== n && "header" !== n && "style" !== n || (o = r.Demo.defs(n),
                s(a = "aside" === n ? c : "header" === n ? m : d).removeClass(r.Demo.style("all", n)),
        ...
        update: function(e, t, o) {
            var a, n = r.Demo.style(t, e), i = r.Demo.style("all", e);
            r.Demo.apps();
            "aside" !== e && "header" !== e || (s(a = "header" == e ? m : c).removeClass(i),
            s(a).addClass(n)),
            ...
            d.addClass(n)),
            "skin" === e && (a = r.Demo.skins(n),
            i = s("#skin-default").attr("href").replace("theme", "skins/" + a),
            "theme" === a ? s(u).remove() : 0 < s(u).length ? s(u).attr("href", i) : l.append('<link id="skin-theme" rel="stylesheet" href="' + i + '">')),
            !0 === o && r.Demo.save(e, t)
        },
        reset: function() {
            var t = r.Demo.apps();
            ...
            s(u).remove(),
            s(c).removeClass(r.Demo.style("all", "aside")),
            s(m).removeClass(r.Demo.style("all", "header"));
            for (var e = 0, o = i; e < o.length; e++) {
                var a = o[e];
                s("[data-key='" + a + "']").each(function() {
                    var e = s(this).data("update");
                    "aside" !== a && "header" !== a && "style" !== a || e === v[t][a] && s(this).addClass("active"),
                    "mode" !== a && "skin" !== a || e !== n && "default" !== e || s(this).addClass("active")
                }),
                r.Demo.remove(a)
            }
        ...
        load: function() {
            ...
            0 < s(h).length && s(h).each(function() {
                var e = s(this).data("update")
                  , t = s(this).data("key");
                "aside" !== t && "header" !== t && "style" !== t || e === r.Demo.defs(t) && (s(this).parent(y).find(h).removeClass("active"),
                s(this).addClass("active")),
                "mode" !== t && "skin" !== t && "dir" !== t || e != r.Demo.current("skin") && e != r.Demo.current("mode") && e != r.Demo.current("dir") || (s(this).parent(y).find(h).removeClass("active"),
                s(this).addClass("active"))
            })
        },
        trigger: function() {
    ...
    r.Promo = function() {
        ...
        0 < e.length && e.on("click", function() {
            ...
            t.addClass("active"),
            null == e && Cookies.set("cypt-offer", "true", {
                expires: 1,
                path: ""
            }),
            !1
