...
!function(p, x) {
    ...
    p.CurrentLink = function() {
        ...
        x(".nk-menu-link, .menu-link, .nav-link").each(function() {
            var e = x(this)
              , t = e.attr("href");
            n.match(t) ? (e.closest("li").addClass("active current-page").parents().closest("li").addClass("active current-page"),
            e.closest("li").children(".nk-menu-sub").css("display", "block"),
            e.parents().closest("li").children(".nk-menu-sub").css("display", "block")) : e.closest("li").removeClass("active current-page").parents().closest("li:not(.current-page)").removeClass("active")
        })
    }
    ,
    p.StickyNav = function() {
        var e = document.querySelectorAll(".nk-header");
        0 < e.length && e.forEach(function(e) {
            30 < window.scrollY ? e.classList.add("has-fixed") : e.classList.remove("has-fixed")
        })
    }
    ,
    p.StickyNav.init = function() {
        p.StickyNav(),
    ...
    p.Toast = function(e, t, n) {
        ...
        "" !== (e = "" !== e ? i + '<div class="toastr-text">' + e + "</div>" : "") && (!0 === n.clear && toastr.clear(),
        a = {
            closeButton: !0,
            debug: !1,
            newestOnTop: !1,
    ...
    p.TGL.content = function(e, t) {
        ...
        c.on("mouseup", function(e) {
            ...
            t.is(e.target) || 0 !== t.has(e.target).length || n.is(e.target) || 0 !== n.has(e.target).length || 0 !== x(e.target).closest(".select2-container").length || a.is(e.target) || 0 !== a.has(e.target).length || i.is(e.target) || 0 !== i.has(e.target).length || (p.Toggle.removed(t.data("target"), s),
            o = !1))
        }),
        r.on("resize", function() {
            n.each(function() {
    ...
    p.TGL.expand = function(e, t) {
        ...
        x(e).on("click", function(e) {
            p.Toggle.trigger(x(this).data("target"), a),
            e.preventDefault()
        })
    }
    ,
    p.TGL.ddmenu = function(e, t) {
        var e = e || ".nk-menu-toggle"
          ...
          , a = t ? u(n, t) : n;
        x(e).on("click", function(e) {
            (p.Win.width < d.lg || x(this).parents().hasClass(l)) && p.Toggle.dropMenu(x(this), a),
            e.preventDefault()
        })
    }
    ,
    p.TGL.showmenu = function(e, t) {
        ...
        n.on("click", function(e) {
            p.Toggle.trigger(x(this).data("target"), o),
            e.preventDefault()
        }),
        c.on("mouseup", function(e) {
    ...
    p.Ani.formSearch = function(e, t) {
        var n = {
          ...
          , i = x(e)
          , o = x(a.target);
        i.exists() && (i.on("click", function(e) {
            e.preventDefault();
            var e = x(this).data("target")
              , t = x("[data-search=" + e + "]")
              , e = x("[data-target=" + e + "]");
            t.hasClass(a.active) ? (e.add(t).removeClass(a.active),
            setTimeout(function() {
                t.find("input").val("")
            }, a.timeout)) : (e.add(t).addClass(a.active),
            t.find("input").focus())
        }),
        c.on({
            keyup: function(e) {
        ...
        e.exists() && e.each(function() {
            ...
            a.steps({
                ...
                onStepChanging: function(e, t, n) {
                    return n < t || (t < n && (a.find(".body:eq(" + n + ") label.error").remove(),
    ...
    p.BS.ddfix = function(e, t) {
        ...
        p.State.isRTL && x(".dropdown-menu").each(function() {
            var e = x(this);
            e.hasClass("dropdown-menu-end") && !e.hasClass("dropdown-menu-center") ? e.prev('[data-bs-toggle="dropdown"]').dropdown({
                popperConfig: {
    ...
    p.BS.tabfix = function(e) {
        x(e || '[data-bs-toggle="modal"]').on("click", function() {
            ...
            e && "#" !== e && t ? t.find('[href="' + e + '"]').tab("show") : t && (n = t.find(".nk-nav.nav-tabs"),
    ...
    p.Control = function(e) {
        document.querySelectorAll(e).forEach(function(e, t, n) {
            ...
            e.addEventListener("change", function() {
                ...
                "radio" == e.type && (document.querySelectorAll('input[name="' + e.name + '"]').forEach(function(e, t, n) {
        ...
        a.forEach(function(e, t, n) {
            ...
            a[t].addEventListener("click", function() {
                ...
                s.forEach(function(e, t, n) {
                    var a, i, o;
                    s[t].classList.contains("number-spinner") && (a = "" == !s[t].value ? parseInt(s[t].value) : 0,
                    i = "" == !s[t].step ? parseInt(s[t].step) : 1,
                    o = "" == !s[t].max ? parseInt(s[t].max) : 1 / 0,
                    s[t].value = a + i < o + 1 ? a + i : a)
                })
            })
        }),
        i.forEach(function(e, t, n) {
            ...
            i[t].addEventListener("click", function() {
                ...
                s.forEach(function(e, t, n) {
                    ...
                    s[t].classList.contains("number-spinner") && (a = "" == !s[t].value ? parseInt(s[t].value) : 0,
                    i = "" == !s[t].step ? parseInt(s[t].step) : 1,
                    o = "" == !s[t].min ? parseInt(s[t].min) : 0,
                    s[t].value = o - 1 < a - i ? a - i : a)
                })
            })
        })
    }
    ...
    p.Custom.Stepper = function(n, e) {
        var t = !(!n.dataset.stepInit || isNaN(n.dataset.stepInit)) && parseInt(n.dataset.stepInit)
          ...
          , o = (n.querySelector(".".concat(t.selectors.progress)),
        ...
        function y(e) {
            ...
            i[t].classList.add(u),
            e);
            1 === t && (c.style.display = "block",
            r.style.display = "none",
            l.style.display = "none",
            n.setAttribute("data-step-current", "first")),
            h !== t & 1 !== t && (r.style.display = "block",
            c.style.display = "block",
            l.style.display = "none",
            n.setAttribute("data-step-current", t)),
            h === t && (r.style.display = "block",
            l.style.display = "block",
            c.style.display = "none",
            n.setAttribute("data-step-current", "last")),
            b && (o.innerHTML = "".concat(e, " of ").concat(h),
            s.style.width = "".concat(100 / h * e, "%"))
        }
        m !== h && v ? console.error("Stepper nav should have same amount of child element as Stepper steps") : y(e);
        ...
        r.querySelector("button").addEventListener("click", function(e) {
            ...
            var e = k.form()
              , t = g - 1;
            e ? h !== g && (v && a[t].classList.add(p),
            i[t].classList.add(f)) : (v && a[t].classList.remove(p),
            i[t].classList.remove(f)),
            y(--g)
        }),
    ...
    p.Tagify = function(e, t) {
        x(e).exists() && "function" == typeof x.fn.tagify && (t = t ? u(void 0, t) : void 0,
        x(e).tagify(t))
    }
    ,
    ...
    p.Preloader = function() {
        ...
        e.exists() && (a.addClass("page-loaded"),
        e.delay(600).fadeOut(300))
    }
    ,
    p.Filter = function(e, t) {
        document.querySelectorAll(e).forEach(function(e) {
            var n, a;
            void 0 !== e && null != e && (n = new Isotope(e,{
                itemSelector: t,
                layoutMode: "fitRows",
                filter: function(e) {
                    return !0
            ...
            a.forEach(function(t) {
                t.addEventListener("click", function(e) {
                    matchesSelector(e.target, "button") && (e = e.target.getAttribute("data-filter"),
                    n.arrange({
                        filter: e
                    }),
    ...
    p.OtherInit = function() {
        ...
        p.Filter(".filter-container", ".filter-item")
    }
    ,
    p.Ani.init = function() {
    ...
    p.init = function() {
        ...
        p.coms.winLoad.push(p.StickyNav.init),
